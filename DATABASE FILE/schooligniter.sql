...
(1, 'School Admin', 'admin@gmail.com', '123456', '1');
...
(1, 'First Terminal Examination', '2025-02-11', 'none'),
(2, 'Second Terminal Examination', '2025-03-24', 'none'),
(3, 'Final Examination', '2025-05-15', 'none');
-- --------------------------------------------------------
...
(1, 'O', '6', 90, 100, 'Outstanding'),
(2, 'A+', '5', 80, 89, 'Excellent'),
(3, 'A', '4', 70, 79, 'Very Good'),
(4, 'B+', '3', 60, 69, 'Good'),
(5, 'B', '2', 50, 59, 'Above Average'),
(6, 'C', '1', 40, 49, 'Average'),
(7, 'F', '0', 0, 39, 'Fail');
...
(1, 1, 'Yearly Fee', 'none', 158850, '158850', '0', 1449702000, '', '', '', 'paid'),
(2, 3, 'Yearly Payment', 'Payment for the month - Feb', 124589, '0', '124589', 1646089200, '', '', '', 'unpaid'),
(3, 10, 'Yearly Fees - 2022', 'Fees collection for the month of February', 589745, '589745', '0', 1646002800, '', '', '', 'paid'),
(4, 5, 'Yearly Fees', 'Fees collection for the month 2024', 213564, '213564', '0', 1646002800, '', '', '', 'paid'),
(5, 7, 'Yearly Fees ', 'Fees Collection for the 2024', 254872, '0', '254872', 1646002800, '', '', '', 'unpaid'),
(6, 9, 'semester Fees', 'none', 100254, '100254', '0', 1646002800, '', '', '', 'paid');
...
CREATE TABLE `mark` (
  ...
  `student_id` int(11) NOT NULL,
  `section_id` int(11) NOT NULL,         -- <-- ADD THIS LINE HERE
  `subject_id` int(11) NOT NULL,
  `class_id` int(11) NOT NULL,
  `exam_id` int(11) NOT NULL,
...
(1, 3, 7, 5, 1, 55, 20, 'Need to improve'),
(2, 4, 7, 5, 1, 71, 20, 'Good, keep it up!'),
(3, 5, 7, 5, 1, 45, 20, 'Need to focus more, just passed!'),
(4, 6, 7, 5, 1, 80, 20, 'Well done!'),
(5, 7, 7, 5, 1, 50, 20, 'Need to improve'),
(6, 8, 7, 5, 1, 76, 20, 'Good, keep it up!'),
(7, 9, 7, 5, 1, 79, 20, 'Good, keep it up!'),
(8, 3, 8, 5, 1, 68, 20, 'none'),
(9, 4, 8, 5, 1, 40, 20, 'none'),
(10, 5, 8, 5, 1, 22, 20, 'none'),
(11, 6, 8, 5, 1, 0, 20, ''),
(12, 7, 8, 5, 1, 0, 20, ''),
(13, 8, 8, 5, 1, 0, 20, ''),
(14, 9, 8, 5, 1, 0, 20, ''),
(15, 13, 8, 5, 1, 0, 20, ''),
(16, 3, 9, 5, 1, 79, 20, 'none'),
(17, 4, 9, 5, 1, 0, 20, ''),
(18, 5, 9, 5, 1, 0, 20, ''),
(19, 6, 9, 5, 1, 0, 20, ''),
(20, 7, 9, 5, 1, 0, 20, ''),
...
(4, 'eb7157e52314645', 'This is a test reply from Dinaol.', 'student-2', '1647099931', 1),
...
(1, 'Mrs Isha Reddy', 'ishareddy@gmail.com', '123456', '+919876543210', '21 MG Road, Andheri East, Mumbai, MH', 'Software Engineer'),
(2, 'Mr Kunal Sharma', 'parent@gmail.com', '123456', '+919988776655', '12 Connaught Place, New Delhi, DL', 'Bank Manager'),
(3, 'Dawit Alemu', 'dawitalemu@gmail.com', '123456', '+251911234567', 'Bole Sub-City, Addis Ababa', 'Software Developer'),
(4, 'Mahlet Tadesse', 'mahlettadesse@gmail.com', '123456', '+251944567890', 'Kebele 08, Hawassa, Sidama Region', 'Civil Engineer'),
(5, 'Emmanuel Johnson', 'emmanueljohnson@gmail.com', '123456', '+231770123456', 'Benson Street, Monrovia', 'Teacher'),
(6, 'Blessing Doe', 'blessingdoe@gmail.com', '123456', '+231880234567', 'Sinkor, Monrovia', 'Nurse'),
(7, 'Samuel Weah', 'samuelweah@gmail.com', '123456', '+231880456789', 'Tubman Boulevard, Congo Town', 'Civil Engineer'),
(8, 'Blessing Smith', 'blessingsmith@gmail.com', '123456', '+231776234567', 'Sinkor, 12th Street, Monrovia', 'Store Manager'),
(9, 'Chinedu Okeke', 'chineduokeke@gmail.com', '123456', '+2348031234567', 'Lekki Phase 1, Lagos', 'Software Developer'),
(10, 'Amina Bello', 'aminabello@gmail.com', '123456', '+2348022345678', 'Wuse Zone 2, Abuja', '	Lawyer'),
(11, 'Ibrahim Musa', 'ibrahimmusa@gmail.com', '123456', '+2347013456789', 'Tarauni, Kano', 'Doctor'),
(12, 'Fatima Abdullahi', 'fatimaabdullahi@gmail.com', '123456', '+234 8076789012', 'Minna, Niger State', 'Sales Manager'),
(13, 'Robel Kebede', 'robelkebede@gmail.com', '123456', '+251955678901', 'Haya Hulet, Addis Ababa', 'House Wife'),
(14, 'Samrawit Getachew', 'samrawitgetachew@gmail.com', '123456', '+251966789012', 'Megenagna, Yeka Sub-City, Addis Ababa', 'Pharmacist'),
(15, 'Devansh Joshi', 'devanshjoshi@gmail.com', '123456', '+919443322110', '64 Satellite Road, Ahmedabad, GJ', 'Civil Engineer'),
(16, 'Priya Nair', 'priyanair@gmail.com', '123456', '+919797979797', '58 Anna Nagar, Chennai, T', '	Doctor'),
(17, 'Ananya Deshmukh', 'ananyadeshmukh@gmail.com', '123456', '+919867001234', '40 Law College Rd, Pune, MH', 'Photographer');
-- --------------------------------------------------------
...
(1, 0, 'Yearly Fee', 'income', 1, 1, '1', 'asd', '158850', '1449702000'),
(2, 0, 'Yearly Payment', 'income', 2, 3, '1', 'Payment for the month - Feb', '0', '1646089200'),
(3, 0, 'Yearly Fees - 2022', 'income', 3, 10, '3', 'Fees collection for the month of August', '589745', '1646002800'),
(4, 0, 'Yearly Fees', 'income', 4, 5, '1', 'Fees collection for the month February', '213564', '1646002800'),
(5, 0, 'Monthly Fees - Feb', 'income', 5, 12, '1', 'Fees Collection for the month February', '0', '1646002800'),
(6, 0, 'semester Fees', 'income', 6, 9, '2', 'none', '100254', '1646002800');
...
(1, 'system_name', ' Smart School Management System<br> Yohanen Dinagde University of<br>          TECHNOLOGY'),
(2, 'system_title', 'Smart School Management System<br> Yohanen Dinagde University of<br>          TECHNOLOGY'),
...
(1, 'Kaushik Dhuliya', '12/05/2003', 'Male', '', '', 'Uttarkash, Uttarakhand', '+91457865235685', 'student@gmail.com', '123456', '', '', '2', 1, 2, '3', 0, 0, '22'),
(2, 'Bipul Singh', '02/16/2004', 'Male', '', '', '302 New Delhi', '+917400012544', 'bipulsingh@gmail.com', '123456', '', '', '3', 3, 1, '1', 0, 0, '44'),
(3, 'Diya Petwal', '09/26/2005', 'Female', '', '', 'Rishikesh, Uttarakhand', '+918541110101', 'diyapetwal@gmail.com', '123456', '', '', '5', 7, 5, '1', 0, 0, '33'),
(4, 'Yohanen Dinagde', '06/05/2000', 'Male', '', '', 'Addis Ababa, Ethiopia', '+917409283325', 'yohanendinagde2@yahoo.com', 'Tewabech@123', '', '', '5', 7, 6, '2', 0, 0, '14'),
(5, 'Jiya Tiyagi', '01/21/2004', 'Female', '', '', '32 Mumbai, India', '+917800024580', 'jiyatiyagi@gmail.com', '123456', '', '', '5', 7, 7, '3', 0, 0, '55'),
(6, 'Yashank Gupta', '24/05/2004', 'Male', '', '', 'Uttarpradesh', '+914587777700', 'yg4321@mail.com', '123456', '', '', '5', 7, 8, '4', 0, 0, '66'),
(7, 'Miicheal Kayanda', '01/30/2004', 'Male', '', '', 'Der salam, Tanzania', '+914780145690', 'Michealkayanda@gmail.com', '123456', '', '', '5', 7, 9, '5', 0, 0, '77'),
(8, 'Len Paing Hlieh', '20/08/2004', 'Female', '', '', 'Yangon, Burmese', '+914569874500', 'lenpainghlieh@gmail.com', 'bubu22', '', '', '5', 8, 10, '1', 0, 0, '403'),
(9, 'Chaltu Dinagde', '12/27/2005', 'Female', '', '', 'Addis Ababa', '+2519701597530', 'chaltudinagde@gmail.com', '123456', '', '', '5', 8, 11, '2', 0, 0, '99'),
(10, 'Ruth Sloan', '07/16/2006', 'Female', '', '', '206 Tavern Place', '4785698740', 'ruths@gmail.com', '123456', '', '', '4', 5, 3, '3', 0, 0, '101');
-- --------------------------------------------------------
...
(3, 'Advance Web Technologies', 2, 1),
(4, 'NET Framework and Technologies', 2, 3),
(5, 'Gender Equality', 3, 4),
(6, 'C Programming ', 4, 5),
(7, 'Advanced Java', 5, 5),
(8, 'Data structure in c	', 5, 6),
(9, 'Mini Project', 5, 2),
(10, 'Software Engineering', 5, 5),
(11, 'Theory of computation	', 5, 6),
(12, 'Computer Fundamental Organization', 5, 2);
...
(1, 'Dr Ashish Kumar Aacharya', '06/07/1989', 'Male', '', '', 'Dehradun, Uttarakhand, India', '+919750104915', 'ashishkumar@gmail.com', '123456'),
(2, 'Mr Ajay Singh Rawat', '03/25/1992', 'Male', '', '', 'Dehradun, Uttarakhand,  India', '+917895123850', 'teacher@gmail.com', '123456'),
(3, 'miss Divya Singh', '09/09/1991', 'female', '', '', 'Haridwar, Uttarakhand, India', '+913698885555', 'Divyasingh@gmail.com', '123456'),
(4, 'Mrs Ruby Faizan', '08/11/1988', 'female', '', '', 'Uttarpradesh, India', '+910369999969', 'rubyfaizan@gmail.com', '123456'),
(5, 'Mrs Vyeshikha', '09/08/1988', 'Female', '', '', 'Rishikesh, Uttarakhand, India', '+917850002500', 'Vyeshikha@gmail.com', '123456'),
(6, 'Mr Yogesh Juyal', '07/05/1987', 'Male', '', '', 'Rajasthan, India', '+917505783884', 'yogeshjuyal@gmail.com', '123456');
...
(1, 'Premnagar to Clock Tower', 'UK07 AB 1234', '₹20 per person', '27'),
(2, 'Haridwar to Rishikesh	', 'UK08 CY 9821', '₹30 per person', '29'),
(3, 'Ballupur to Mussourie	', 'UK11 DL 4523', '₹50 per person', '35');
--
