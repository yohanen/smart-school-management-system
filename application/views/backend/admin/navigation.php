<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'marks') echo 'active'; ?> ">
                    <!-- Link to marks selection form, parameters are selected in the form -->
                    <a href="<?php echo base_url(); ?>index.php?admin/marks">
                        <span><i class="entypo-dot"></i> <?php echo ('View Marks'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <!-- SEND REPORT -->
        <li class="<?php if ($page_name == 'send_report') echo 'opened active'; ?> ">
            <a href="#">
                <i class="entypo-paper-plane"></i>
                <span><?php echo ('Send Report'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'send_marks') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/send_marks">
                        <span><i class="entypo-dot"></i> <?php echo ('Send Marks'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'send_attendance') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/send_attendance">
                        <span><i class="entypo-dot"></i> <?php echo ('Send Attendance'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
