                ...
                <tr class="gradeA">
                    ...
                    <td>
                        <select name="section_id" class="form-control" id="section_selector_holder">
                            ...
                            ?>
                                <option value="<?php echo $row['section_id'];?>" <?php if(isset($section_id) && $section_id == $row['section_id'])echo 'selected';?>>
                                    <?php echo $row['name'];?>
                                </option>
                    ...
                    <td>
                        <select name="subject_id" class="form-control" id="subject_selector_holder">
                            ...
                            ?>
                                <option value="<?php echo $row['subject_id'];?>" <?php if(isset($subject_id) && $subject_id == $row['subject_id'])echo 'selected';?>>
                                    <?php echo $row['name'];?>
                                </option>
                            <?php endforeach; endif; ?>
                        </select>
...
<?php if($date!='' && $month!='' && $year!='' && $class_id!='' && $section_id!='' && $subject_id!=''):?>
...
<form method="post" 
    action="<?php echo base_url();?>index.php?teacher/manage_attendance/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id.'/'.$section_id.'/'.$subject_id;?>">
        <div class="col-sm-offset-3 col-md-6">
            <table  class="table table-bordered table-hover table-striped">
                <thead>
                    <tr class="gradeA">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $("select[name='class_id']").change(function() {
            ...
            select_section(class_id);
            select_subject(class_id);
        });
    });
</script>